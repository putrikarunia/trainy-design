...
import { Sheet, SheetTrigger, SheetClose, SheetContent, SheetHeader, SheetFooter, SheetTitle } from '../../components/ui/sheet'
...
export default function SheetDescriptionSnapshot({
  __onRender,
  className,
  props,
}: {
