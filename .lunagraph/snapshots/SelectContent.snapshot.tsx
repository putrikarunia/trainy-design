...
import { Select, SelectGroup, SelectItem, SelectLabel, SelectScrollDownButton, SelectScrollUpButton, SelectSeparator, SelectTrigger, SelectValue } from '../../components/ui/select'

export default function SelectContentSnapshot({
  __onRender,
  className,
  children,
  ...
  const __propsKey = React.useMemo(() => {
    try {
      return JSON.stringify({ className, children, position, align, props }, (key, value) => {
