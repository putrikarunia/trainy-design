...
import { Select, SelectContent, SelectGroup, SelectItem, SelectLabel, SelectScrollDownButton, SelectScrollUpButton, SelectSeparator, SelectValue } from '../../components/ui/select'

export default function SelectTriggerSnapshot({
  __onRender,
  className,
  size = "default",
  children,
  ...
  const __propsKey = React.useMemo(() => {
    try {
      return JSON.stringify({ className, size, children, props }, (key, value) => {
