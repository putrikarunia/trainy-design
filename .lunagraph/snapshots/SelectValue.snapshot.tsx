...
import { Select, SelectContent, SelectGroup, SelectItem, SelectLabel, SelectScrollDownButton, SelectScrollUpButton, SelectSeparator, SelectTrigger } from '../../components/ui/select'

export default function SelectValueSnapshot({
  __onRender,
  props,
}: {
  props?: any
