...
import { Sheet, SheetClose, SheetContent, SheetHeader, SheetFooter, SheetTitle, SheetDescription } from '../../components/ui/sheet'
...
export default function SheetTriggerSnapshot({
  __onRender,
  props,
}: {
  props?: any
