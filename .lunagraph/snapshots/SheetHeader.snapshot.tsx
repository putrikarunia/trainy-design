...
import { Sheet, SheetTrigger, SheetClose, SheetContent, SheetFooter, SheetTitle, SheetDescription } from '../../components/ui/sheet'
...
export default function SheetHeaderSnapshot({
  __onRender,
  className,
  props,
}: {
