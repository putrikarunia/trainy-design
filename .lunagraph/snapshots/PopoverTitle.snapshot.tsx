...
import { Popover, PopoverTrigger, PopoverContent, PopoverAnchor, PopoverHeader, PopoverDescription } from '../../components/ui/popover'

export default function PopoverTitleSnapshot({
  __onRender,
  className,
  props,
}: {
