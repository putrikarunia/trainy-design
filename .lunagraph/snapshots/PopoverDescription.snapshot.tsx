...
import { Popover, PopoverTrigger, PopoverContent, PopoverAnchor, PopoverHeader, PopoverTitle } from '../../components/ui/popover'

export default function PopoverDescriptionSnapshot({
  __onRender,
  className,
  props,
}: {
