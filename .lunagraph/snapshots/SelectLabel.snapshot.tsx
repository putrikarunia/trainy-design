...
import { Select, SelectContent, SelectGroup, SelectItem, SelectScrollDownButton, SelectScrollUpButton, SelectSeparator, SelectTrigger, SelectValue } from '../../components/ui/select'

export default function SelectLabelSnapshot({
  __onRender,
  className,
  props,
}: {
