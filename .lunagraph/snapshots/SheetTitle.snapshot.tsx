...
import { Sheet, SheetTrigger, SheetClose, SheetContent, SheetHeader, SheetFooter, SheetDescription } from '../../components/ui/sheet'
...
export default function SheetTitleSnapshot({
  __onRender,
  className,
  props,
}: {
