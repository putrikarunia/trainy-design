...
import { Select, SelectContent, SelectItem, SelectLabel, SelectScrollDownButton, SelectScrollUpButton, SelectSeparator, SelectTrigger, SelectValue } from '../../components/ui/select'

export default function SelectGroupSnapshot({
  __onRender,
  props,
}: {
  props?: any
