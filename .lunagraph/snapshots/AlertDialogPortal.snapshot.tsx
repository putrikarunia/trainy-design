...
import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogMedia, AlertDialogOverlay, AlertDialogTitle, AlertDialogTrigger } from '../../components/ui/alert-dialog'

export default function AlertDialogPortalSnapshot({
  __onRender,
  props,
}: {
  props?: any
