    ...
    <TabsListContext.Provider value={{ variant }}>
      <TabsPrimitive.List
        ...
        className={cn(
          ...
          variant === "default" && "bg-ed-muted text-ed-muted-foreground h-9 rounded-lg p-1",
          variant === "simple" && "h-auto gap-2 border-b border-ed-border justify-start",
          className
        )}
        {...props}
      />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ed-ring focus-visible:ring-offset-2",
