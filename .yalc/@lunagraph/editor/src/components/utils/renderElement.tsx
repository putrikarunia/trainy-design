...
import { FEElement, IconLibraryConfig, ComponentElement, ViewportElement } from "../types";
...
export function renderElement(
  ...
  if (element.type === "html") {
    ...
    if (isEditing) {
      ...
      const autoSizeHeight = (el: HTMLTextAreaElement, minHeight: number) => {
      ...
      if (!Component) {
        ...
        content = createElement(
          ...
          createElement(
            ...
            { elementId: element.id, elementName: element.componentName },
    ...
    return (
      <ViewportRenderer key={element.id} element={viewportElement} options={options} />
    );
  }
  ...
  const draggableContent = shouldSkipWrapper ? (
    ...
    <DraggableElement
      ...
      onMouseOver={commonProps.onMouseOver}
