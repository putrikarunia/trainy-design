 ...
 */
export function getDeviceNameForWidth(width) {
    if (width >= 1280)
        return 'Desktop';
    if (width >= 1024)
        return 'Laptop';
 ...
 */
export function ViewportRenderer({ element, options }) {
    ...
    const [elementResizing, setElementResizing] = useState(null);
    const { selectedElementIds = new Set(), canvasScale = 1 } = options;
    ...
    const handleChildSelect = useCallback((id, addToSelection) => {
        options.onSelectElement?.(id, addToSelection);
    }, [options]);
    const handleChildHover = useCallback((id) => {
    ...
    const handleElementResizeStart = useCallback((e, id, handle, rect) => {
        e.preventDefault();
        e.stopPropagation();
        setElementResizing({
            id,
    ...
    const { viewportWidth, viewportHeight, deviceName, children, styles, } = element;
  ...
  `;
    ...
    const renderOverlay = (id, isSelected) => {
        ...
        return (_jsxs("div", { style: {
                ...
                borderRadius: '2px',
                        ...
                        transformOrigin: 'bottom left',
                    }, children: getElementLabel(el) }), isSelected && (_jsxs(_Fragment, { children: [_jsx("div", { style: {
                                position: 'absolute',
                                width: handleSize,
                                height: handleSize,
                                background: 'white',
                                ...
                                cursor: 'nw-resize',
                                pointerEvents: 'auto',
                            }, onMouseDown: (e) => handleElementResizeStart(e, id, 'nw', rect) }), _jsx("div", { style: {
                                position: 'absolute',
                                width: handleSize,
                                height: handleSize,
                                background: 'white',
                                ...
                                cursor: 'ne-resize',
                                pointerEvents: 'auto',
                            }, onMouseDown: (e) => handleElementResizeStart(e, id, 'ne', rect) }), _jsx("div", { style: {
                                position: 'absolute',
                                width: handleSize,
                                height: handleSize,
                                background: 'white',
                                ...
                                cursor: 'sw-resize',
                                pointerEvents: 'auto',
                            }, onMouseDown: (e) => handleElementResizeStart(e, id, 'sw', rect) }), _jsx("div", { style: {
                                position: 'absolute',
                                width: handleSize,
                                height: handleSize,
                                background: 'white',
                                ...
                                cursor: 'se-resize',
                                pointerEvents: 'auto',
                            }, onMouseDown: (e) => handleElementResizeStart(e, id, 'se', rect) })] }))] }, id));
    };
    ...
    return (_jsxs("div", { ref: setNodeRef, "data-element-id": element.id, "data-viewport-width": viewportWidth, style: {
            ...styles,
            position: 'relative',
            width: viewportWidth,
            height: frameHeight,
            ...
            setHoveredChildId(null);
        }, ...attributes, children: [_jsxs("div", { style: {
                    position: 'absolute',
                    ...
                    e.stopPropagation();
                    options.onSelectElement?.(element.id, e.shiftKey);
                }, ...listeners, children: [displayName, " (", viewportWidth, "\u00D7", frameHeight, ")"] }), _jsx(Frame, { ref: frameRef, initialContent: initialContent, mountTarget: "#viewport-root", style: {
                    width: '100%',
                    height: '100%',
                    ...
                    if (iframe?.contentDocument) {
                ...
                }, children: _jsx(FrameContextConsumer, { children: ({ document: frameDocument, window: frameWindow }) => (_jsxs("div", { style: {
                            width: '100%',
                            minHeight: '100%',
                            position: 'relative',
                        }, onClick: (e) => {
                        ...
                        }, children: [children?.map((child) => renderElement(child, childOptions)), hoveredChildId && !selectedChildIds.has(hoveredChildId) && renderOverlay(hoveredChildId, false), Array.from(selectedChildIds).map(id => renderOverlay(id, true))] })) }) }), _jsx("div", { style: {
                    position: 'absolute',
                    ...
                    height: '100%',
                    cursor: 'ew-resize',
                }, onMouseDown: (e) => handleResizeMouseDown(e, 'e') }), _jsx("div", { style: {
                    position: 'absolute',
                    left: 0,
                    ...
                    cursor: 'ns-resize',
                }, onMouseDown: (e) => handleResizeMouseDown(e, 's') }), _jsx("div", { style: {
                    position: 'absolute',
                    right: -resizeHandleWidth / 2,
                    bottom: -resizeHandleWidth / 2,
